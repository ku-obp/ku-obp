...
import { MonopolyCookie, MonopolySettings, GameTrading, MonopolyMode } from "@/lib/monopoly-types";
                    ...
                    function func() {
                        if (advanced) {
                            ...
                            if (b) {
                                ...
                                const transformCount = (v: 0 | 2 | 1 | 3 | 4 | "h") => {
                                    switch (v) {
                                        case "h":
                                            return 5;
                ...
                <div style={{ overflowY: "hidden" }}>
                    ...
                    <div className="action-bar" style={prop.myTurn && !sended ? {} : { translate: "-50% 20vh" }}>
                        ...
                        <button data-button-type="roll" aria-disabled={false}>
                            <p>ROLL THE </p>
                            <img style={{ marginLeft: 10 }} src={getIcon("roll")} />
                        </button>
                                                    ...
                                                    prop.players
                                                        ...
                                                        .map((v, i) => (
                                                            ...
                                                            >
                                                                ...
                                                                <div>
                                                                    {v.count == "h" ? (
                                                                        <img src={getIcon("ho")} alt="" />
                                                                    ) : typeof v.count === "number" && v.count > 0 ? (
                                                                        <>
                                                                            <p>{v.count}</p>
                                                                            <img src={getIcon("h")} alt="" />
                                                                        </>
                                                                    ) : (
                                                                        <></>
                                                                    )}
