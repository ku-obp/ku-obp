...
import { Player } from "../../../public/assets/monopoly/player";
// import { Socket } from "../../../public/assets/monopoly/sockets";
import StreetCard, { StreetDisplayInfo, UtilitiesDisplayInfo, RailroadDisplayInfo, translateGroup } from "./streetCard";
...
const MonopolyGame = forwardRef<MonopolyGameRef, MonopolyGameProps>((prop, ref) => {
    ...
    function diceAnimation(a: number, b: number) {
        ...
        function randomCube() {
            var l = "/assets/images/monopoly/c";
    ...
    useImperativeHandle(ref, () => ({
        ...
        setStreet: (args) => {
            ...
            if (x && args.location !== -1 && args.location < 40 && args.location >= 0) {
                const searchForButtons = function(
                    advanced: boolean,
                    location: number,
                    fartherInfo?: {
                        rolls: number;
                    ...
                    function func() {
                        if (advanced) {
                            ...
                            if (b) {
                                ...
                                const transformCount = function(v: 0 | 2 | 1 | 3 | 4 | "h") {
                                    switch (v) {
                                        case "h":
                                            return 5;
                            ...
                            switch (state) {
                                ...
                                case 4:
                                    for (let index = 0; index < state; index++) {
                                        const image = document.createElement("img");
                                        image.src = "/assets/images/monopoly/h.png";
                                        st.appendChild(image);
                                    }
                                    break;
                                case "h":
                                    const image = document.createElement("img");
                                    image.src = "/assets/images/monopoly/ho.png";
                                    st.appendChild(image);
                                    break;
                ...
                <div style={{ overflowY: "hidden" }}>
                    ...
                    <div className="action-bar" style={prop.myTurn && !sended ? {} : { translate: "-50% 20vh" }}>
                        ...
                        <button data-button-type="roll" aria-disabled={false}>
                            <p>ROLL THE </p>
                            <img style={{ marginLeft: 10 }} src="/assets/images/monopoly/roll.png" />
                        </button>
                        <button data-button-type="pay" data-tooltip-hover="pay" aria-disabled={true}>
                            <img src="/assets/images/monopoly/pay1.png" />
                        </button>
                        <button data-button-type="card" data-tooltip-hover="card" aria-disabled={true}>
                            <img src="/assets/images/monopoly/golden-card.png" />
                        </button>
                        {prop.selectedMode.AllowDeals ? (
                            ...
                            >
                                <img src="/assets/images/monopoly/morgage.png" />
                            </button>
                        ) : (
                            <></>
                        )}
                                                    ...
                                                    prop.players
                                                        ...
                                                        .map((v, i) => (
                                                            ...
                                                            >
                                                                ...
                                                                <div>
                                                                    {v.count == "h" ? (
                                                                        <img src="/assets/images/monopoly/ho.png" alt="" />
                                                                    ) : typeof v.count === "number" && v.count > 0 ? (
                                                                        <>
                                                                            <p>{v.count}</p>
                                                                            <img src="/assets/images/monopoly/h.png" alt="" />
                                                                        </>
                                                                    ) : (
                                                                        <></>
                                                                    )}
