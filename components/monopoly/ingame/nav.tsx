...
// import { Server, Socket } from "../../../public/assets/monopoly/sockets";
import PropretyTab, { PropretyTabRef } from "./propretyTab";
import PlayersTab, { PlayersTabRef } from "./playersTab";
import SettingsNav from "../settingsNav";
import { MonopolyMode, historyAction } from "../../../public/assets/monopoly/types";
    ...
    useImperativeHandle(ref, () => ({
        addMessage(arg) {
            ...
            if (tabIndex !== 2) {
                ...
                imageElement.src = "/assets/images/monopoly/chat_new.png";
                iconElement.onclick = () => {
                    imageElement.src = "/assets/images/monopoly/chat.png";
    ...
    return (
        <nav className="main">
            <nav className="header">
                <img style={{ marginTop: 75 }} className="header" src="/assets/images/monopoly/icon.png" />
                <div className="upper">
                    <div
                        ...
                        className="button"
                    >
                        <img src="/assets/images/monopoly/players.png" alt="" />
                    </div>
                    ...
                    <div
                        ...
                        className="button"
                    >
                        <img src="/assets/images/monopoly/proprety.png" alt="" />
                    </div>
                    ...
                    <div
                        ...
                        id="chatIconChange"
                    >
                        <img src="/assets/images/monopoly/chat.png" alt="" />
                    </div>
                    <div
                ...
                <div className="lower">
                    ...
                    <div
                        ...
                        className="button"
                    >
                        <img src="/assets/images/monopoly/settings.png" alt="" />
                    </div>
                    <div
                    ...
                    >
                        <img src="/assets/images/monopoly/leave1.png" alt="" />
                    </div>
                </div>
            </nav>
