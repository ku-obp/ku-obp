...
import { MonopolyMode, historyAction } from "@/lib/monopoly-types";
    ...
    useImperativeHandle(ref, () => ({
        addMessage(arg) {
            ...
            if (tabIndex !== 2) {
                ...
                imageElement.src = getIcon("chat_new");
                iconElement.onclick = () => {
                    imageElement.src = getIcon("chat");
    ...
    return (
        <nav className="main">
            <nav className="header">
                <img style={{ marginTop: 75 }} className="header" src={getIcon("icon")} />
                <div className="upper">
                    <div
